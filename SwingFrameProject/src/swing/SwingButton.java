...
public class SwingButton {
	...
	public static void main(String[] args) {
		...
		JLabel l1,l2,l3,l4,l5,l6,l7,lresult1,lresult2,lresult3,lresult4,lresult5,lresult6,lresult7,tfresult1,tfresult2,tfresult3,tfresult4,tfresult5,tfresult6,tfresult7;
		...
		lresult1.setBounds(50, 460, 200, 30);
		
		 lresult2 = new JLabel("LastName");
		lresult2.setBounds(50, 490, 200, 30);
		 lresult3 = new JLabel("UserID:");
		lresult3.setBounds(50, 520, 200, 30);
		 lresult4 = new JLabel("Password:");
		lresult4.setBounds(50, 550, 200, 30);
		lresult5 = new JLabel("Reset Password:");
		lresult5.setBounds(50, 580, 200, 30);
		 lresult6 = new JLabel("Mobile Number:");
		lresult6.setBounds(50, 610, 200, 30);
		 lresult7 = new JLabel("Email ID:");
		lresult7.setBounds(50, 640, 200, 30);

		 tfresult1 = new JLabel();
		 tfresult1.setBounds(200, 460, 200, 30);
			
		 tfresult2 = new JLabel();
		 tfresult2.setBounds(200, 490, 200, 30);
		 tfresult3 = new JLabel();
		 tfresult3.setBounds(200, 520, 200, 30);
		 tfresult4 = new JLabel();
		 tfresult4.setBounds(200, 550, 200, 30);
		 tfresult5 = new JLabel();
		 tfresult5.setBounds(200, 580, 200, 30);
		 tfresult6= new JLabel();
		 tfresult6.setBounds(200, 610, 200, 30);
		 tfresult7 = new JLabel();
		 tfresult7.setBounds(200, 640, 200, 30);

		//final JTextField tf=new JTextField();
		//tf.setBounds(50, 350, 150, 20);
		JButton b=new JButton("Login");
		b.setBounds(130, 400, 150, 35);
